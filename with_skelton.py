...
@st.cache_resource
def load_model():
    return joblib.load("ssl_hand_gesture_model_2.pkl")

model = load_model()

labels = ["سنة", "أسبوع", "شهر", "الأربعاء", "الجمعة", "الثلاثاء", "الأثنين", "الأحد", "يوم", "الخميس", "السبت", "لغة الإشارة السعودية", "السلام عليكم", "الله يحفظك", "الله يحييك", "إن شاء الله", "تعاون", "تفضل", "تواصل", "صباح الخير", "كيف الحال", "مساء الخير"]
